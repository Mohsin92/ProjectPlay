...
import com.varshaaweblabs.ecommerce.ProductFullDetails.Delegates.SizeItemSingleDelegate;
...
public class ProductSize_Adapter extends RecyclerView.Adapter implements SizeItemSingleDelegate.SingleItemHelper {
    ...
    public ProductSize_Adapter(Context mContext, Helper mListener) {
        this.mListener = mListener;
        ArrayList<Attribute_Group> grp_att = new ArrayList<>();
        delegatesManager = new AdapterDelegatesManager<>();
        delegatesManager.addDelegate(new SizeItemSingleDelegate(mContext, this));
    }
    ...
    public void selectedItem(Attribute_Group mColorItem, int Pos) {
        ...
        if (mListener != null) {
            mListener.onSizeItemSelected(mColorItem);
        }
       notifyDataSetChanged();
    }
    ...
    public interface Helper {
        ...
        void onSizeItemSelected(Attribute_Group mSingleChoiceItem);
